...
Level sticks until changed or the next session-start lifecycle event. Startup,
resume, clear, and compact reload the configured default, matching the bundled
Ponytail hook behavior.
...
activate manually with `$ponytail` when wanted.
