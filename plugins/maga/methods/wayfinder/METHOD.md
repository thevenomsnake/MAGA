...
finding that way, not charging at the destination. This method charts the way
...
live is tracker-specific.** Consult the tracker doc's "Wayfinding operations"
section for how _this_ repo expresses them. If the user intends to configure a
missing tracker, first read and apply
[the setup method](../setup-matt-pocock-skills/METHOD.md); otherwise default to
