...
Preserve facts, source boundaries, uncertainty, capabilities, privacy claims, CTA, brand terms, citations, and the user's deliberate voice. Only calibrate expression from an author sample when the user explicitly designates it for this task; treat it as temporary evidence, never infer or persist a writer profile, and never copy its facts or errors. Keep code, commands, paths, URLs, identifiers, placeholders, variables, ICU messages, markup, data, machine-readable syntax, and verbatim quotations exact unless the user explicitly asks to change them.
